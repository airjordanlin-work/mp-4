...
public class SelectStatement extends SQLStatement {
    ...
    public void execute() throws DatabaseException, DeadlockException {
        ...
        try {
            ...
            if (this.numTables() != 1) {
                throw new Exception("Specifying multiple tables in SELECT clause not supported");
            }


            if (this.numColumns() != 0) {
                throw new Exception("SELECT clause with specified column names not supported");
            }
